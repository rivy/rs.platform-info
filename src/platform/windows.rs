...
// experimentation: see <https://chat.openai.com/share/dd5543e8-6dd8-4689-896b-4c412ea16e67> , <https://users.rust-lang.org/t/asref-in-option-is-awkward-to-use/2596> , <https://users.rust-lang.org/t/the-many-mysteries-of-option-dyn-asref-path/42062/4>
// fn version_info_from_file<I, P>(file_path: I) -> Result<WinOsVersionInfo, WinOSError>
// where
//     I: Into<Option<P>>,
//     P: AsRef<OsStr>,
// {
//     version_info_from_file_(file_path.into())
// }
// fn version_info_from_file_<P>(file_path: Option<P>) -> Result<WinOsVersionInfo, WinOSError>
// where
//     P: AsRef<OsStr>,
// {
...
// fn no_path() -> Option<&'static std::path::Path> {
//     None
// }
// fn no_string() -> Option<&'static str> {
//     None
// }
// const NONE_STR: &str = "";
...
fn test_version_vs_version() {
    ...
    // let version_via_file = version_info_from_file(NONE).unwrap();
    // let version_via_file = version_info_from_file(None::<&str>).unwrap();
    // let version_via_file = version_info_from_file(None).unwrap();
